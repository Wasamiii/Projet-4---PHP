...
class CommentManager extends Manager
{
    ...
    {
        $db = $this->dbConnect();
        $comments = $db->prepare('SELECT id_post, authors, comment_text, DATE_FORMAT(comment_date, \'%d/%m/%Y à %Hh%imin%ss\') AS comment_date_fr FROM comments WHERE comment_id = ? ORDER BY comment_date DESC');
